...
type GeneratorRequest struct {
	Template   entities.Template          `json:"templates"`
	Photoshop  entities.DesignFile        `json:"photoshop"`
	Components []entities.LayoutComponent `json:"components"`
	Elements   []entities.LayoutElement   `json:"elements"`
}
...
type GenerateImageRequest struct {
	...
	Prancheta  entities.Layout `json:"prancheta,omitempty"`
}
