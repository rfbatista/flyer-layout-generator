...
INSERT INTO layout (width, height, design_id, request_id, is_original, image_url, stages, template_id) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING *;
...
-- name: ListLayoutFromAdaptation :many
SELECT layout.*
FROM layout
